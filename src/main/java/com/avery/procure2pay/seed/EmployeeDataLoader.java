...
public class EmployeeDataLoader implements CommandLineRunner {
    ...
    private void loadEmployeeData() {
        if (employeeRepository.count() == 0) {
            ...
            Employee employee1 = new Employee("Thomas", "Carter", "Sales", "Staff", "thoas.hotmail@gmail.com", "");
            Employee employee2 = new Employee("Connie", "Jones", "Cooperate", "Staff", "connie.jones@gmail.com", "");
